# UI Foundry Lightbox Studio

Standalone visual Lightbox generator built with Next.js, React, and TypeScript.

Standalone Lightbox component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Lightbox UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Lightbox generator
...
The editor is focused on controls that are native to Lightbox and useful in real product work:
- open state, active image, previous/next controls, close behavior, caption, counter, and overlay
- backdrop, frame, radius, shadow, controls, thumbnails, and motion-safe transitions
- gallery, product, portfolio, document, and media preview variants
- dialog-like expectations and accessible control labels
- React export for lightbox presentation

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Lightbox.
...
This repo is intended to publish as Abid-Al-Hossain/UI_lightbox.
