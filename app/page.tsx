...
export default function Page() {
  const [state, setState] = useState<LightboxState>(DEFAULT_LIGHTBOX_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Lightbox Studio" controls={controls} preview={output} /></AppShell>;
}
