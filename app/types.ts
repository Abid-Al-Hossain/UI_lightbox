...
export type StudioPreset = { id: string; family: string; archetype: string; variant: string; size: string; tags: string[]; state: Partial<LegacyLightboxPresetState> & Record<string, unknown> };
